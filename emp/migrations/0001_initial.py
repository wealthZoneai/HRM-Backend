    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(blank=True, choices=[('PYTHON', 'Python'), ('QA', 'QA'), ('JAVA', 'Java'), ('UIUX', 'UI/UX'), ('REACT', 'React'), ('CYBER_SECURITY', 'Cyber Security'), ('DIGITAL_MARKETING', 'Digital Marketing'), ('HR', 'HR'), ('BDM', 'BDM'), ('NETWORKING', 'Networking'), ('CLOUD', 'Cloud')], max_length=100, null=True)),
