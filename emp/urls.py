...
urlpatterns = [
    ...
    path('timesheet/daily/update/', views.TimesheetDailyUpdateAPIView.as_view(),
         name='timesheet_daily_update'),
    path('timesheet/clock-in/', views.TimesheetClockInAPIView.as_view(),
         name='timesheet_clock_in'),
    path('timesheet/clock-out/', views.TimesheetClockOutAPIView.as_view(),
         name='timesheet_clock_out'),
